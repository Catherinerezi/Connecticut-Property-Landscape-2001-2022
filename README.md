...
## 5. How are property counts distributed across price bands by RFM segment which bands are dominated by where to prioritise premium listings, and where to run value-uplift plays?
